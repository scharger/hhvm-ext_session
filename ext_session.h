...
struct SessionModule {
  ...
  virtual bool open(const char *save_path, const char *session_name, const char *memcache_host, const char *memcache_port) = 0;
...
struct SystemlibSessionModule : SessionModule {
  ...
  virtual bool open(const char *save_path, const char *session_name, const char *memcache_host, const char *memcache_port);
  virtual bool close();
